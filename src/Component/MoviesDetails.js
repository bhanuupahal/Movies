...
<div className="w-full md:w-1/4">
  ...
  <div className="hidden md:block bg-gradient-to-br from-red-600 to-red-400 p-4 rounded-lg shadow-lg">
    <h2 className="text-white text-lg font-bold mb-4">🎬 Recent Movies</h2>
    <ul className="space-y-3 text-white text-sm list-disc list-inside">
      ...
      <li>Karate Kid: Legends 2025 Hindi Dual Audio WEB-DL 720p - 480p - 1080p</li>
      <li>Kapkapiii 2025 Hindi WEB-DL 720p - 480p - 1080p</li>
      <li>Aazam 2023 Hindi WEB-DL 720p - 480p - 1080p</li>
      <li>Robinhood 2025 Hindi Dual Audio WEB-DL 720p - 480p - 1080p</li>
      <li>Jurassic World: Rebirth 2025 Hindi HDTC 720p - 480p - 1080p</li>
      <li>Kuberaa 2025 Hindi Dual Audio WEB-DL 720p - 480p - 1080p</li>
      <li>Sri Sri Sri Raja Vaaru 2025 Hindi Dual Audio WEB-DL 720p - 480p - 1080p</li>
    </ul>
  </div>
  ...
  {showModal && (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
      <div className="relative bg-white w-11/12 max-w-md rounded-lg shadow-xl p-6">
        ...
        <h3 className="text-lg font-bold text-gray-800 mb-4">🎬 Recent Movies</h3>
